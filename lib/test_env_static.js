...
const debug = require('debug')('dply:test-helpers:TestEnvStatic')
const Promise = require('bluebird')
const path = require('path')
const fse = require('fs-extra')

const { FsException, FsNotFoundError, TestEnvException } = require('./errors')
...
module.exports = { TestEnvStatic, FsException, FsNotFoundError }
